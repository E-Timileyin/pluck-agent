...
export function SupportPage(props: { shell: Shell; questionCount: number }) {
  ...
  const faqs: Faq[] = [
    ...
    },
    {
      ...
      answer:
        "Yes, as often as you like. The timer is started once and switching format never resets it.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "No. An answer is scored the moment you submit it, and the question you were asked is stored with it, so a later edit to the quiz cannot change your result.",
    },
    {
      question: "I did not pass. What now?",
      answer:
        "Take it again attempts are unlimited and every one is kept. Your result screen shows the correct answer for everything you missed.",
    },
    {
      question: "My name or phone number is wrong.",
      answer:
        "You can correct your name, email and tier on the Profile screen. The phone number identifies your record across attempts and only a supervisor can change it.",
    },
  ];
  ...
  return (
    <PromoterShell
      ...
      header={
        <PageHeader
          title="Support"
          sub="How this training works, and who to ask when it does not."
        />
      }
    >
      <div class="grid gap-3 md:grid-cols-2 lg:grid-cols-3">
        ...
        <Card tone="tint" title="Still stuck?">
          <p class="m-0 mb-3 text-[13px]/[1.6] text-ink">
            Nothing you have done is lost. Your answers are saved as you give
            them, and you are on the <strong>{progress.current}</strong> step
